...
4. Click on the button below and follow the instructions. This process can take up to a few minutes.<br />
  <div align="center">
    <a href="https://deploy.cloud.run?git_repo=https://github.com/bibixx/pjatk-ical-sync" target="_blank">
...
5. Add the calendar subscription to your calendar app of choice. The url for the subscription will be presented in GCP as
    ```
